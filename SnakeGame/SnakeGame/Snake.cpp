...
namespace SnakeGame
{
	...
	void InitSnake(Snake& snake, Game& game)
	{
		...
		{
		case Difficulty::Low:
			snake.speed = INITIAL_SPEED * LOW_DIFFICULT_MULTIPLAYER;

			break;
		case Difficulty::LowUp:
			snake.speed = INITIAL_SPEED * LOWUP_DIFFICULT_MULTIPLAYER;

			break;
		case Difficulty::Medium:
			snake.speed = INITIAL_SPEED * MEDIUM_DIFFICULT_MULTIPLAYER;

			break;
		case Difficulty::HardLow:
			snake.speed = INITIAL_SPEED * HARDLOW_DIFFICULT_MULTIPLAYER;

			break;
		case Difficulty::Hard:
			snake.speed = INITIAL_SPEED * HARD_DIFFICULT_MULTIPLAYER;
